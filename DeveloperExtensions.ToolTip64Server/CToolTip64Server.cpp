...
// CToolTip32Server
STDMETHODIMP CToolTip64Server::GetToolTip(/*[in]*/ BSTR filename, /*[out, retval]*/ BSTR* tooltip)
{
	...
	bstrInfo.Append("  Machine: [64-bit]\n  ");
...
DWORD CToolTip64Server::GetBaseAddressOf(wchar_t *pwcs)
{
...
#pragma warning(disable:4302)
	return reinterpret_cast<DWORD>(pvModulePreferredBaseAddr);
}

CComBSTR CToolTip64Server::IsRegistredInCOMPlus(wchar_t *pwcs)
{
...
vector<CComBSTR> CToolTip64Server::ContainsProgID(wchar_t *pwcs)
{
...
bool CToolTip64Server::IsDllCOMServer(wchar_t *pwcs)
{
	HMODULE hModule = ::LoadLibraryEx(pwcs, NULL, DONT_RESOLVE_DLL_REFERENCES );
	if (hModule != NULL) {
